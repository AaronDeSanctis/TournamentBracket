...
namespace Obsidian.Controllers
{
    public class TournamentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Bracket,Game,Genre,IsCompleted")] Tournament tournament)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Bracket,Game,Genre,IsCompleted")] Tournament tournament)
        {
            if (ModelState.IsValid)
            {
